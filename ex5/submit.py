...
part_names = [
    ...
    'Regularized Linear Regression Gradient', 'Learning Curve',
    'Polynomial Feature Mapping', 'Validation Curve'
]

srcs = [
    'linearRegCostFunction.py', 'linearRegCostFunction.py', 'learningCurve.py',
    'polyFeatures.py', 'validationCurve.py'
]
